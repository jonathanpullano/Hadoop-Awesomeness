...
public class Constants {
    ...
    public final static boolean DEBUG = false; // FINAL STATIC optimizes out if(DEBUG) statements
    ...
    /*
     * public static void setParams(final int N_in, final int g_in) { N = N_in; g = g_in; M = (int)
     * Math.sqrt(N); numGroups = M / g; groupSize = M * (g + 1); }
     */
}
